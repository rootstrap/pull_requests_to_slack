...
1. Read, understand and agree to our [code of conduct](https://github.com/rootstrap/pull_requests_to_slack/blob/master/CODE_OF_CONDUCT.md)
2. [Fork the repo](https://help.github.com/articles/about-forks/)
3. Clone the project into your machine:
`$ git clone git@github.com:rootstrap/pull_requests_to_slack.git`
4. Access the repo:
`$ cd pull_requests_to_slack`
